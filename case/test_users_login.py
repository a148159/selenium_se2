...
class TestUserLoginPage():
    ...
    def open_register(self, usersLoginPage:UserUsersLoginPage):
        usersLoginPage.open("/users/login/")

    def test_users_login_1(self, usersLoginPage:UserUsersLoginPage):
    ...
    def test_users_login_2(self, usersLoginPage:UserUsersLoginPage):
    ...
    def test_users_login_3(self, usersLoginPage:UserUsersLoginPage):
    ...
    def test_users_login_4(self, usersLoginPage:UserUsersLoginPage, base_url):
